        ...
        if (response.ok) {
          ...
          if (data.messages && data.messages.length > 0) {
            ...
            const welcomeMessage = {
              content: `Bienvenue dans le chat santé. Je suis votre assistant virtuel, prêt à vous aider et à répondre à vos questions. Attention : je ne remplace en aucun cas un médecin ou un professionnel de santé. Pour tout problème médical sérieux, veuillez consulter un professionnel. Comment puis-je vous assister aujourd'hui ?`,
              sender: "bot",
            };
          ...
          {messages.map((message, index) => (
            <li
              ...
              <strong
                ...
                {message.sender === "user" ? "Vous" : "Dr. santé"}:
              </strong>
              <p
