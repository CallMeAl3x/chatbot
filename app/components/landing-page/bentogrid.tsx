...
const CardWithEffect = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div
      className="relative bg-[#ECEDFD] flex-1 rounded-xl border border-black/10 p-4 overflow-hidden"
  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-black text-2xl font-bold mb-2">AWS Integration</h1>
...
const BentoBox1 = () => {
  ...
  return (
    <div className="bg-[#fff] flex justify-center items-center min-h-screen p-5 rounded-lg sm:py-24 ">
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="mb-4 px-6 mt-6">
              <div className="flex justify-between items-center mb-6 pb-2">
                <h2 className="text-black/70 text-xl">Sales Data</h2>
                <div className="flex items-center">
                  <div className="h-1 bg-white w-8 rounded-lg"></div>
                  <span className="ml-2 text-black/70 text-sm">Growth</span>
                </div>
              </div>
              <div ref={chartRef} className="relative w-full mt-12" style={{ height: chartHeight }}>
                <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="w-full h-full pl-11">
                  <defs>
                    <linearGradient id="gradient" x1="0" x2="0" y1="0" y2="1">
                      <stop offset="0%" stopColor="#9295F4FF" />
                      <stop offset="100%" stopColor="#ECEDFD" />
                    </linearGradient>
                  </defs>
                  <polyline
                    fill="url(#gradient)"
                ...
                <div className="absolute top-0 left-0 h-full w-full pointer-events-none">
                  {Array.from(Array(7).keys()).map((i) => (
                    <div
                      key={i}
                      className="absolute left-0 w-full flex items-center text-black/30 text-sm"
                      style={{ top: `${(100 / 6) * i}%` }}
                    >
            ...
            <div className="text-left p-6 mt-4">
              <h1 className="text-black text-2xl font-bold mb-2">Incredible Growth</h1>
              <p className="text-black/70 text-lg">Fly through your tasks with rapid-fire keyboard shortcuts for everything. Literally everything.</p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-black text-2xl font-bold mb-2">Multiple Technologies</h1>
                <p className="text-black/70 text-lg">Fly through your tasks with rapid-fire keyboard shortcuts for everything. Literally everything.</p>
              </div>
            </div>
          </CardWithEffect>
